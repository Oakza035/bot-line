...
settings = {
  ...
  💀꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂💀 
🎁🎁🎁🎁🎁🎁🎁🎁🎁🎁🎁
selfbot by:꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂
╔══════════════┓
╠™ BY.꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂
╚══════════════┛
""",
    "message1":"บัญชีนี้ถูกป้องกันโดย Selfbot BY.꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂ระบบได้ทำการบล็อคคุณอัตโนมัติเนื่องจากคุณยังไม่ได้ยืนยันตัวตนกับผู้สร้างบอท\nสามารถยืนตัวตนได้ง่ายโดยการพิม unblockกับ BY. ꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂ ระบบจะทำการปลดบล็อคท่านโดยอัตโนมัต",
    "comment1":""" [SELF BOT OAK PY3 ON...] """,
    "comment":"""    ─┅═✥👊ᵀᴴᴬᴵᴸᴬᴺᴰ👊✥═┅─ 
  💀꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂💀 
🎁🎁🎁🎁🎁🎁🎁🎁🎁🎁🎁
selfbot by: ꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂
...
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("BY. ꧁༺సণξ'ꪧণईꢗนŦђєǾάĶ༻꧂",mi_d)
                    ...
                    mi_d = Mids[:33]
                    line.createGroup("꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂", mi_d)
                    line.sendText(msg.to,"꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂")
                    line.createGroup("꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂", mi_d)
                    line.sendText(msg.to,"꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂")
                        ...
                        line.createGroup("꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂",[key])
                        line.sendText(msg,to,"꧁༺సণξ'ꪧণईꢗน ŦђєǾάĶ༻꧂")
...
#===================================================================#              
                ...
                elif ".บาย" in msg.text:
                	if msg.toType == 2:
                         _name = msg.text.replace(".บาย","")
